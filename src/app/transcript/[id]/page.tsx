        ...
        {!loading && !notFound && (
          <div className="mt-16 pt-8 border-t border-black/15 flex justify-center">
            <button
              ...
              className="group inline-flex items-center gap-[0.575rem] border-2 border-ink bg-transparent px-[1.4375rem] py-[0.575rem] text-[1.006rem] font-headline uppercase tracking-wide text-black hover:bg-trash hover:text-white hover:border-trash transition-colors"
            >
